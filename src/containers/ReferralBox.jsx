				...
				<div className="box">
					<div className="row">
						<div className="col-xs-12">
							...
							<h4>Here is your unique referral link: <a href={`${config.DOMAIN}?ref=${this.props.order.referral_code[0].code}`} className="text-nasdaqBlue" target="_blank" onClick={this.trackRefShare}>{config.DOMAIN}/?ref={this.props.order.referral_code[0].code}</a></h4>
